...
data class MuScheduleBroadcast(
        ...
        @SerialName("Description") val description: String,
        @SerialName("Subtitle") val subtitle: String = "",
        @SerialName("StartTime") @Serializable(with = DateDeserializer::class) val startTime: Long,
        @SerialName("EndTime") @Serializable(with = DateDeserializer::class) val endTime: Long,
        ...
        @SerialName("AnnouncedStartTime") @Serializable(with = DateDeserializer::class) val announcedStartTime: Long,
        @SerialName("AnnouncedEndTime") @Serializable(with = DateDeserializer::class) val announcedEndTime: Long,
...
data class ProgramCard(
        ...
        @SerialName("PrimaryBroadcastStartTime") @Serializable(with = DateDeserializer::class) val primaryBroadcastStartTime: Long? = null,
        @SerialName("SortDateTime") @Serializable(with = DateDeserializer::class) val sortDateTime: Long = 0L,
...
@Serializable
data class Info(
        @SerialName("StartPublish") @Serializable(with = DateDeserializer::class) val startPublish: Long,
        @SerialName("EndPublish") @Serializable(with = DateDeserializer::class) val endPublish: Long)
