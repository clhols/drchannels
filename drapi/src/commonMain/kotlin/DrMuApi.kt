...
data class MuNowNext(
        ...
        @SerialName("Next") val next: List<MuScheduleBroadcast>)
...
data class ProgramCard(
        ...
        @SerialName("PrePremiere") val prePremiere: Boolean,
        @SerialName("ExpiresSoon") val expiresSoon: Boolean,
        ...
        @SerialName("SortDateTime") @Serializable(with = DateSerializer::class) val sortDateTime: Date,
