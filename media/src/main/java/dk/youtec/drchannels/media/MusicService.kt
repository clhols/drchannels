...
package dk.youtec.drchannels.media
...
import dk.youtec.drchannels.media.library.BrowseTree
import dk.youtec.drchannels.media.library.JsonSource
import dk.youtec.drchannels.media.library.MusicSource
import dk.youtec.drchannels.media.library.UAMP_BROWSABLE_ROOT
import dk.youtec.drchannels.media.library.UAMP_EMPTY_ROOT
...
class MusicService : androidx.media.MediaBrowserServiceCompat() {
    ...
    override fun onCreate() {
        ...
        mediaSessionConnector = MediaSessionConnector(mediaSession).also {
            ...
            val playbackPreparer = DrPlaybackPreparer(
                    mediaSource,
                    exoPlayer,
                    dataSourceFactory)
